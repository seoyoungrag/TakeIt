...
export default class Drawer extends Component {
  ...
  componentWillMount() {
    ...
    if (!this.props.rightDisabled) {
      this._pan = PanResponder.create({
        ...
        onMoveShouldSetPanResponder: this._onMoveShouldSetPanResponder.bind(
          this
        ),
        onMoveShouldSetPanResponderCapture: this._onMoveShouldCapture.bind(
          this
        ),
        ...
        onShouldBlockNativeResponder: this._shouldBlockNativeResponder.bind(
          this
        )
      });
    } else {
  ...
  _handlePanResponderEnd(evt, gestureState) {
    ...
    if (isOpen && this.props.rightDisabled) {
      return true;
    }
  }
