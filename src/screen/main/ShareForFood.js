...
import { Dimensions, View,ScrollView,Text,PixelRatio } from "react-native";
...
export default class ShareForFood extends Component {
  constructor(props) {
    super(props);
    this.state = {
              ...
              <View style={{height:width-width*0.15, width: width-width*0.1}}>
                <View style={{position:"absolute", height:"100%",width:"100%",zIndex:1,alignItems:"center",justifyContent:"center",flexDirection:"row"}}>
                  ...
                  <Text style={{
                    ...
                    textAlign:"center",
                    textAlignVertical:"center"}}>
                    {this.state.food.registTime&&this.state.food.registTime.toString()&&this.state.food.registTime.toString().length==13 ?
                    ...
                    {this.state.food.foodList && this.state.food.foodList.length > 0  ?  
                    (<ScrollView>
